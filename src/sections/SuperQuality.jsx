  ...
  return (
    <section id='about-us' className='max-container flex justify-between items-center max-lg:flex-col gap-10 w-full'>
      <div className='flex flex-1 flex-col'>
         <h2 className='font-palanquin text-4xl capitalize lg:max-w-lg font-bold'>We Provide You <span className='text-coral-red'>Super Quality</span> Shoes</h2>
      ...
      <div className='flex-1 flex justify-center items-center'>
        <img src={shoe8} alt="shoe8" width={570} height={522} className='object-contain hover:scale-105 transition-all duration-300'/>
      </div>
    </section>
  )
}
