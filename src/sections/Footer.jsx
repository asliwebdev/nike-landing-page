  ...
  return (
    <footer className="max-container">
         ...
         <div className="flex flex-col items-start">
           ...
           <div className="flex items-center gap-5 mt-8">
              {socialMedia.map(icon => (
                  <a href={icon.url} target="_blank" key={icon.src} className="flex justify-center items-center w-12 h-12 bg-white rounded-full cursor-pointer hover:bg-gray-300 ">
      ...
      <div className="flex justify-between text-white-400 mt-24 max-sm:flex-col max-sm:items-center">
        ...
        <a href="https://agreementservice.svs.nike.com/us/en_us/rest/agreement?agreementType=termsOfUse&uxId=com.nike.commerce.nikedotcom.web&country=US&language=en&requestType=redirect" 
        target="_blank"
        className="font-montserrat cursor-pointer hover:text-slate-gray">Terms & Conditions</a>
      </div>
    </footer>
  )
}
